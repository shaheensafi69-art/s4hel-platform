...
`+w(e)+i+"\n\nWhat do these logs indicate? What steps can I take to resolve it? Keep your answer very concise and actionable. Max 2 or 3 bullet points."}e.s(["apiKey",()=>S,"buildLogsPrompt",()=>R,"checkForILIKEClause",()=>y,"checkForWithClause",()=>b,"extractEdgeFunctionName",()=>P,"fillTimeseries",0,(e,t,r,s,n,a,i=20,l)=>{let u;if(0===e.length&&!(n&&a))return[];if(e.length>i)return e.map(e=>{let r=e[t],s=d(r)?c(r):o.default.utc(r).toISOString();return e[t]=s,e});if(e.length<=1&&!(n&&a))return e;let g=e.map(e=>o.default.utc(e[t])),p=a?o.default.utc(a):o.default.utc(Math.max.apply(null,g)),m=n?o.default.utc(n):o.default.utc(Math.min.apply(null,g)),f=e.length>0?g:[m,p],_=1;if(l){let e=l.match(/^(\d+)(m|h|d|s)$/);e?(_=parseInt(e[1],10),u=({s:"second",m:"minute",h:"hour",d:"day"})[e[2]]):u=h(f)}else u=h(f);0!==e.length||l||(u="minute");let b=e.map(e=>{let s=e[t],n=d(s)?c(s):o.default.utc(s).toISOString();return Array.isArray(r)&&0===r.length?{[t]:n}:(e[t]=n,e)}),y=m;for(;y.isBefore(p)||y.isSame(p);){if(!g.find(e=>e.year()===y.year()&&e.month()===y.month()&&e.date()===y.date()&&e.hour()===y.hour()&&e.minute()===y.minute()&&e.second()===y.second())){let e=("string"==typeof r?[r]:r).reduce((e,t)=>({...e,[t]:s}),{});b.push({[t]:y.toISOString(),...e})}y=y.add(_,u)}return b},"formatLogsAsJson",()=>O,"formatLogsAsMarkdown",()=>w,"genChartQuery",0,(e,t,r)=>{let s,n,a,i,l,c,[d,g]=(s=t.iso_timestamp_end?(0,o.default)(t.iso_timestamp_end):(0,o.default)(),n=t.iso_timestamp_start?(0,o.default)(t.iso_timestamp_start):(0,o.default)(),a="minute",i=360,l=s.diff(n,"minute"),c=s.diff(n,"hour"),l>720?(a="hour",i=120):c>72&&(a="day",i=7),[n.add(-i,a),a]),h=p(e,r),_=function(e){switch(e){case"edge_logs":case"function_edge_logs":return"response.status_code >= 500";case"postgres_logs":case"pg_cron_logs":return"parsed.error_severity IN ('ERROR', 'FATAL', 'PANIC')";case"auth_logs":return"metadata.level = 'error' OR SAFE_CAST(metadata.status AS INT64) >= 400";case"function_logs":return"metadata.level IN ('error', 'fatal')";default:return"false"}}(e),b=function(e){switch(e){case"edge_logs":case"function_edge_logs":return"response.status_code >= 400 AND response.status_code < 500";case"postgres_logs":return"parsed.error_severity IN ('WARNING')";case"auth_logs":return"metadata.level = 'warning'";case"function_logs":return"metadata.level IN ('warning')";default:return"false"}}(e);e===u.LogsTableName.PG_CRON&&(e=u.LogsTableName.POSTGRES,h=f);let y=m(e);return`
SELECT
-- log-event-chart
...
ORDER BY
  timestamp ASC
  `},"genCountQuery",0,(e,t)=>{let r=p(e,t);e===u.LogsTableName.PG_CRON&&(e=u.LogsTableName.POSTGRES,r=f);let s=m(e);return`SELECT count(*) as count FROM ${e} ${s} ${r}`},"genDefaultQuery",0,(e,t,s=100)=>{let o=p(e,t),n=m(e),a="order by timestamp desc";switch(e){case"edge_logs":if(!r.IS_PLATFORM)return`
...
${a}
limit ${s}
`}},"genSingleLogQuery",0,(e,t)=>`select id, timestamp, event_message, metadata from ${e} where id = '${t}' limit 1`,"isDefaultLogPreviewFormat",0,e=>e&&e.timestamp&&e.event_message&&e.id,"isUnixMicro",0,d,"jwtAPIKey",()=>v,"maybeShowUpgradePromptIfNotEntitled",0,(e,t)=>!!t&&Math.abs((0,o.default)().diff((0,o.default)(e),"day"))>t,"role",()=>E,"unixMicroToIsoTimestamp",0,c,"useEditorHints",0,()=>{let e=(0,t.useMonaco)();(0,i.useEffect)(()=>{if(e){let t=e.languages.registerCompletionItemProvider("pgsql",{triggerCharacters:["`"," ","."],provideCompletionItems:function(t,r,o){let n=new s.default(t,r.column-2,r.lineNumber-1);if(n.isNextDQuote())return{suggestions:[]};let i=[],u=l.default.schemas.filter(e=>n._text.includes(e.reference));if(0===u.length&&(u=l.default.schemas),n.isNextPeriod()){let t=u.flatMap(e=>e.fields).flatMap(e=>{let[t,...r]=e.path.split(".");return r}).map(t=>({label:t,kind:e.languages.CompletionItemKind.Property,insertText:t}));i=i.concat(t)}if("`"===o.triggerCharacter||" "===o.triggerCharacter){let t=l.default.schemas.map(t=>({label:t.reference,kind:e.languages.CompletionItemKind.Class,insertText:t.reference})),r=u.flatMap(e=>e.fields).flatMap(e=>e.path.split(".").slice(0,-1)).map(t=>({label:t,kind:e.languages.CompletionItemKind.Property,insertText:t}));i=(i=i.concat(r)).concat(t)}return{suggestions:(0,a.default)(i,"label")}}});return()=>{t.dispose()}}},[e])}])},993394,e=>{"use strict";var t,r=e.i(55956),s=e.i(10429);e.i(128328);var o=e.i(86086);let n=`${s.DOCS_URL}/guides/platform/logs#querying-with-the-logs-explorer`,a=[{label:"Recent Errors",mode:"simple",searchString:"[Ee]rror|\\s[45][0-9][0-9]\\s",for:["api"]},{label:"Commits",mode:"simple",searchString:"COMMIT",for:["database"]},{label:"Commits By User",description:"Count of commits made by users on the database",mode:"custom",searchString:`select
  p.user_name,
  count(*) as count
from postgres_logs
