      ...
      <div className="max-w-6xl mx-auto relative z-10 space-y-32">
        <header className="text-center max-w-4xl mx-auto space-y-6">
          ...
          <h1 className="text-5xl md:text-[100px] font-black text-white uppercase tracking-tighter leading-[0.85] italic">
            THE S4HEL <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#64FFDA] via-white to-[#64FFDA] not-italic">
              UNIVERSITY
            </span>
          </h1>
        ...
        <section className="space-y-12">
          <div className="text-center lg:text-left space-y-2 border-b border-white/5 pb-6">
            <span className="text-[#64FFDA] font-mono text-[9px] tracking-[0.4em] uppercase block">
              ENTERPRISE ACADEMIC BLUEPRINTS
            </span>
            <h2 className="text-3xl md:text-4xl font-black text-white uppercase tracking-tight">
              Our Core Curriculums & Faculty
            </h2>
          </div>
              ...
              >
                ...
                <div className="pt-4 border-t border-white/5 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-[9px] font-mono tracking-wider opacity-40 uppercase block leading-none">
                        PROFESSOR
                      </span>
                      <span className="text-white text-xs font-black uppercase tracking-tight block mt-1">
                        {course.instructor}
                      </span>
                    </div>
                  </div>
        ...
        <section className="p-6 md:p-12 rounded-3xl border border-white/5 bg-gradient-to-br from-[#112240]/40 to-transparent">
          <h2 className="text-2xl font-black text-white uppercase tracking-widest mb-12 text-center italic">
            ...
            {[
              {
                n: "01",
                t: "Academic Training",
                d: "Deep education across modern digital markets including Amazon FBA pipelines, Shopify setups, and TikTok Shop conversion models.",
              },
              {
                n: "02",
                t: "Architecture Check",
                d: "Execution of robust Articles of Organization with elite registered agent integration based on your model.",
              },
              {
                n: "03",
                t: "Tax Registry (EIN)",
                d: "Securing corporate Federal Tax Identification data from the IRS and establishing compliance tracking cycles.",
              },
              {
                n: "04",
                t: "Global Scale",
                d: "Deploying high-tier neo-banking frameworks, merchant accounts, and payment systems like Stripe globally.",
              },
            ].map((step, i) => (
          ...
          <div className="max-w-3xl space-y-4">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-8 opacity-80 pt-4">
              <span className="text-[9px] font-black tracking-widest uppercase flex items-center gap-1.5">
                <CheckCircle size={10} /> IRS Standard Compliance
              </span>
              <span className="text-[9px] font-black tracking-widest uppercase flex items-center gap-1.5">
                <CheckCircle size={10} /> State Nexus Integrity
              </span>
              <span className="text-[9px] font-black tracking-widest uppercase flex items-center gap-1.5">
                <CheckCircle size={10} /> KYC/AML Alignment
              </span>
            </div>
          </div>
        </section>
